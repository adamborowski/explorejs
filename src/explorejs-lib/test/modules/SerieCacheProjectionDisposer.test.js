...
describe("SerieCacheProjectionDisposer", ()=> {
    ...
    describe('recompile at different levels', ()=> {
        ...
        it('recompile at raw', ()=> {
            ...
            expect(disposer.getProjection('raw').recompile).to.be.calledOnce;
            expect(disposer.getProjection('10s').recompile).to.be.not.called;
            expect(disposer.getProjection('30s').recompile).to.be.not.called;
            expect(disposer.getProjection('1m').recompile).to.be.not.called;
            expect(disposer.getProjection('30m').recompile).to.be.not.called;
            expect(disposer.getProjection('1h').recompile).to.be.not.called;
            expect(disposer.getProjection('1d').recompile).to.be.not.called;
            expect(disposer.getProjection('30d').recompile).to.be.not.called;
            expect(disposer.getProjection('1y').recompile).to.be.not.called;
        });
        it('recompile at 10s', ()=> {
            disposer.recompile('10s', []);
            expect(disposer.getProjection('raw').recompile).to.be.calledOnce;
            expect(disposer.getProjection('10s').recompile).to.be.calledOnce;
            expect(disposer.getProjection('30s').recompile).to.be.not.called;
            expect(disposer.getProjection('1m').recompile).to.be.not.called;
            expect(disposer.getProjection('30m').recompile).to.be.not.called;
            expect(disposer.getProjection('1h').recompile).to.be.not.called;
        ...
        it('recompile at 30s', ()=> {
            ...
            expect(disposer.getProjection('raw').recompile).to.be.calledOnce;
            expect(disposer.getProjection('10s').recompile).to.be.calledOnce;
            expect(disposer.getProjection('30s').recompile).to.be.calledOnce;
            expect(disposer.getProjection('1m').recompile).to.be.not.called;
            expect(disposer.getProjection('30m').recompile).to.be.not.called;
            expect(disposer.getProjection('1h').recompile).to.be.not.called;
            expect(disposer.getProjection('1d').recompile).to.be.not.called;
        ...
        it('recompile at 1m', ()=> {
            ...
            expect(disposer.getProjection('10s').recompile).to.be.calledOnce;
            expect(disposer.getProjection('30s').recompile).to.be.calledOnce;
            expect(disposer.getProjection('1m').recompile).to.be.calledOnce;
            expect(disposer.getProjection('30m').recompile).to.be.not.called;
            expect(disposer.getProjection('1h').recompile).to.be.not.called;
            expect(disposer.getProjection('1d').recompile).to.be.not.called;
            expect(disposer.getProjection('30d').recompile).to.be.not.called;
        ...
        it('recompile at 10m', ()=> {
            ...
            expect(disposer.getProjection('30s').recompile).to.be.calledOnce;
            expect(disposer.getProjection('1m').recompile).to.be.calledOnce;
            expect(disposer.getProjection('30m').recompile).to.be.calledOnce;
            expect(disposer.getProjection('1h').recompile).to.be.not.called;
            expect(disposer.getProjection('1d').recompile).to.be.not.called;
            expect(disposer.getProjection('30d').recompile).to.be.not.called;
            expect(disposer.getProjection('1y').recompile).to.be.not.called;
        ...
        it('recompile at 1h', ()=> {
            ...
            expect(disposer.getProjection('1m').recompile).to.be.calledOnce;
            expect(disposer.getProjection('30m').recompile).to.be.calledOnce;
            expect(disposer.getProjection('1h').recompile).to.be.calledOnce;
            expect(disposer.getProjection('1d').recompile).to.be.not.called;
            expect(disposer.getProjection('30d').recompile).to.be.not.called;
            expect(disposer.getProjection('1y').recompile).to.be.not.called;
        });
        it('recompile at 1d', ()=> {
            ...
            expect(disposer.getProjection('30m').recompile).to.be.calledOnce;
            expect(disposer.getProjection('1h').recompile).to.be.calledOnce;
            expect(disposer.getProjection('1d').recompile).to.be.calledOnce;
            expect(disposer.getProjection('30d').recompile).to.be.not.called;
            expect(disposer.getProjection('1y').recompile).to.be.not.called;
        });
        it('recompile at 30d', ()=> {
            ...
            expect(disposer.getProjection('1h').recompile).to.be.calledOnce;
            expect(disposer.getProjection('1d').recompile).to.be.calledOnce;
            expect(disposer.getProjection('30d').recompile).to.be.calledOnce;
            expect(disposer.getProjection('1y').recompile).to.be.not.called;
        });
        it('recompile at 1y', ()=> {
            ...
            expect(disposer.getProjection('1d').recompile).to.be.calledOnce;
            expect(disposer.getProjection('30d').recompile).to.be.calledOnce;
            expect(disposer.getProjection('1y').recompile).to.be.calledOnce;
        });
    });
